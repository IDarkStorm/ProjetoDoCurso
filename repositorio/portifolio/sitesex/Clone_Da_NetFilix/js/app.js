alert("Recomendamos o uso do chrome ou navegador semelhante que possui um tradutor, para obiter uma boa experiencia no nosso site :)");
...
function estoupequisando(){
    alert("Certifique que sua pesquisa o nome do filme esta ingles :)");
}